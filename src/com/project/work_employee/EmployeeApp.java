	...
	public static void main(String[] args) throws SQLException {
		...
		while (true) {
			...
			if (input == 1) {
				...
				System.out.println(" 1.인사관리팀");
				System.out.println(" 2.기획팀");
				System.out.println(" 3.마케팅팀 ");
				System.out.println(" 4.기술개발팀");
				System.out.println(" 5.고객상담팀");
				System.out.println(" 6.회계팀");
				System.out.println(" 7.안내데스크");
				System.out.print(">>>>");
